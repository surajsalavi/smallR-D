...
<html>
  ...
  <body>
    Text: <input type="text" id="input_text" placeholder="Text" /><br>
    Duration: <input type="number" id="input_duration" placeholder="Duration in Sec" /><br>
    Font Size<input type="number" id="input_fontSize" placeholder="Font Size" /><br>
          ...
          [
            {
              ...
              textAlign: 'center',
              strokeWidth: 2.5,
              fontSize:document.getElementById('input_fontSize').value,
              y: 80,
